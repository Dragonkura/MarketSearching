...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public EnhancedScrollerCellView GetCellView(EnhancedScrollerCellView cellPrefab, Func<EnhancedScrollerCellView> instantiateFunc = null)
        {
            ...
            if (cellView == null)
            {
                ...
                {
                    cellView = instantiateFunc.Invoke();
                }
